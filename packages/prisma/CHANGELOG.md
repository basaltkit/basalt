...
- 6d446ef: Cross-tenant sweeps: a first-class, safe way for a reconciler to find stuck work in every tenant under RLS (BK-022).
...
- b0cc59f: Row-level security applied automatically, and a boot check for the wrong database.
...
- fb85c40: Security hardening of the Prisma tenancy integration (fail closed by default):
