...
graph TB
    subgraph L4["Camada 4 — Aplicação do usuário"]
        APP["app do desenvolvedor<br/>(create-machize)"]
    end
...
|---|---|---|
| **1 — MVP** (m1–5) | `create-machize` gera API tipada com Prisma + CLI + docs Getting Started | 3 apps reais construídos por early adopters; feedback incorporado |
