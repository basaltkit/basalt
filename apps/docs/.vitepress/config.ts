...
const loadSidebar = (rel: string): unknown[] => {
  try {
    return JSON.parse(
...
const apiSidebar = loadSidebar('../reference/api/typedoc-sidebar.json')
...
const packagesSidebar = loadSidebar('../reference/packages/packages-sidebar.json')
          ...
          '/pt/guide/': [
            {
              ...
              items: [
                ...
                { text: 'Pacotes de driver', link: '/pt/guide/driver-packages' },
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Drives externos', link: '/pt/guide/drives' },
      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: 'Driver packages', link: '/guide/driver-packages' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'External drives', link: '/guide/drives' },
