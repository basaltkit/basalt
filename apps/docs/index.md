...
hero:
  name: Machize
  text: The Laravel-grade toolkit for SaaS on Node.js
...
features:
  ...
  - title: Batteries included
    details: Authentication with refresh rotation, Spatie-style permissions, Cashier-style billing with feature limits — in your database, not a third-party service.
