---
'@machize/storage-gcs': minor
'@machize/storage-azure': minor
---

New packages: `@machize/storage-gcs` and `@machize/storage-azure` — cloud storage drivers for `@machize/storage`.
